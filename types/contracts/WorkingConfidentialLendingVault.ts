...
export interface WorkingConfidentialLendingVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FIXED_INTEREST_RATE"
      | "INITIAL_RATE"
...
export interface WorkingConfidentialLendingVault extends BaseContract {
  connect(runner?: ContractRunner | null): WorkingConfidentialLendingVault;
  waitForDeployment(): Promise<this>;

  interface: WorkingConfidentialLendingVaultInterface;
  ...
  filters: {
    "ConfidentialSupply(address,uint256)": TypedContractEvent<
      ConfidentialSupplyEvent.InputTuple,
      ConfidentialSupplyEvent.OutputTuple,
      ConfidentialSupplyEvent.OutputObject
    >;
    ...
    "ConfidentialWithdraw(address,uint256)": TypedContractEvent<
      ConfidentialWithdrawEvent.InputTuple,
      ConfidentialWithdrawEvent.OutputTuple,
      ConfidentialWithdrawEvent.OutputObject
    >;
