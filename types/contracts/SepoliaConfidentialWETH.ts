...
export interface SepoliaConfidentialWETHInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface SepoliaConfidentialWETH extends BaseContract {
  connect(runner?: ContractRunner | null): SepoliaConfidentialWETH;
  waitForDeployment(): Promise<this>;

  interface: SepoliaConfidentialWETHInterface;
